    ...
    return (
        <Section title={'\u{1F91F} GitHub authorization'}>
            ...
            <Alert type={AlertType.warning}>
                Note; your organization owners might have restricted access to third party apps (e.g. this extension).
                Repositories from such organizations will now show up in search results if you use this authorization
                method.
            </Alert>
            <CenteredContent>
                <Button
                    size={ButtonSize.large}
                    styleType={!buttonMuted ? ButtonType.primary : ButtonType.muted}
                    onClick={onAuthClick}
                >
                    Authorize GitHub
                </Button>
